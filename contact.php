<!-- 
	...
	This code relies on jQuery, PHP, and Ajax.
	To use this out of the box, just edit the URL section of the Ajax call (line 41) and upload it to your server

	// Lines you need to change: 48 
    // If you added/changed variables, also edit lines 16-18, 52, 60-62
-->
...
function sendEmail(){
	...
	// AJAX call to the PHP file which will send the results
		...
		$.ajax({
		    ...
		    url: 'send-form.php', // where is the send-form.php file relative to this file?
		    
		    type: 'post',
		    
		    data: { "email":email, "name":name, "message":message}, // add your new variable here
